...
public class TestJavaquarium {
    ...
    public void test_name_sex() {
        ...
        assertThat(engine.getEntities().get(0).getComponent(SpeciesComponent.class).speciesType).isEqualTo(SpeciesComponent.SpeciesType.MEROU);
        assertThat(engine.getEntities().get(1).getComponent(SpeciesComponent.class).speciesType).isEqualTo(SpeciesComponent.SpeciesType.SOLE);
    }
